				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                    ...
                    @csrf
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30 @error('name') is-invalid @enderror" type="text"  required autocomplete="name" autofocus name="name" value="{{ old('name') }}" placeholder="Enter Your Name">
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
                          <input id="password" type="password" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Enter Your Password">
