...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Document Uploader</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Document uploader Form</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="department-form" action="{{ URL('admin/document-uploader') }}" enctype="multipart/form-data" method="POST">
                                {!! csrf_field() !!}
                                ...
                                @if(isset($row->path) && $action=='edit')
                                @php $tImage = asset($row->file); @endphp
                                <div class="form-group row">
                                  <a  href="{{ $tImage }}" download >Download File</a>  
                                </div>
                                @endif
