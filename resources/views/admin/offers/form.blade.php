...
<div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="number" class="form-control" placeholder="Enter Tax" name="tax" value="{{ $row->tax }}" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Discount <span class="text-red">*</span></label>
                                                    <div class="col-sm-6">
                                                        <input type="number" class="form-control" placeholder="Enter Discount" name="discount" value="{{ $row->discount }}" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
