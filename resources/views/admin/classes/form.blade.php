		    ...
		    <div class="row mb-2">
		      ...
		      <div class="col-sm-6">
		        <ol class="breadcrumb float-sm-right">
		          ...
		          <li class="breadcrumb-item"><a href="{{ URL('admin/classes') }}">Classes</a></li>
											...
											<div class="card-body">
												...
												@foreach($languages as $language)
													...
													<div class="col-sm-4">
														...
														<label>Class Title in {{ $language->name }} <span class="text-red">*</span></label>
													        
														<input type="text" class="form-control" placeholder="Class Title in {{$language->name}} " name="title[{{$language->short_name}}]" value="{{ isset($title[$language->short_name]) ? $title[$language->short_name] : '' }}" required="">
