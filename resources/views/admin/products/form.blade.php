                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <textarea class="form-control" name="description" rows="5" cols="70" required>{{$row->description}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="colsFile" class="collapse" aria-labelledby="file-heading" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group ">
                                                            <label class="form-label">SKU <span class="text-red">*</span></label>
                                                            <input type="text" class="form-control" placeholder="Enter sku" name="sku" value="{{$row->sku}}" required="">
                                                        </div>
                                                    </div>
