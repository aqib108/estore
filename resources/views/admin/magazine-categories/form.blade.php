            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ URL('admin/magazine-categories') }}">Magazine Categories</a></li>
                                            ...
                                            <div class="card-body">
                                                ...
                                                @foreach($languages as $language)
													<div class="col-sm-4">
														...
														<label class="form-label">Category Name {{$language->name }}</label>
															<input type="text" class="form-control" placeholder="Enter Name {{$language->name }}" name="name[{{$language->short_name}}]" value="{{isset($name[$language->short_name])?$name[$language->short_name]:''}}" required="">
														</div>
													</div>
												@endforeach
                                                </div>
