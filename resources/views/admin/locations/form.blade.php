...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Location</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="categories-form" class="form-horizontal label-left" action="{{ URL('admin/locations') }}" enctype="multipart/form-data" method="POST">
                                {!! csrf_field() !!}
                                                ...
                                                <div class="row">
                                                    @foreach($languages as $language)
                                                        <div class="col-sm-4">
                                                            ...
                                                            <label class="form-label">Location Address {{$language->name }}</label>
                                                                <input type="text" class="form-control" placeholder="Enter Location Address {{$language->name }}" name="location_address[{{$language->short_name}}]" value="{{isset($location_address[$language->short_name])?$location_address[$language->short_name]:''}}" required="">
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
                                        ...
                                        <div id="link" class="collapse" aria-labelledby="message-title-heading" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group ">
                                                            <label class="form-label">Location Address Link <span class="text-red">*</span></label>
                                                            <input type="text" class="form-control" placeholder="Enter Location Address Link" name="location_link" value="{{ $row->location_link }}" required="">
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="message" class="collapse" aria-labelledby="message-heading" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group ">
                                                            <label class="col-form-label">Description {{$language->name}} <span class="text-red">*</span></label>
                                                            <textarea id="summernote" name="description[{{$language->short_name}}]" required>{{isset($description[$language->short_name])?$description[$language->short_name]:''}}</textarea>
                                                        </div>
                                                    </div>
                                                    @endforeach
                                                </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group text-right">
                                        <div class="col-sm-12">
                                            <a href="{{ URL('admin/locations') }}" class="btn btn-info" style="margin-right:05px;"> Cancel </a>
