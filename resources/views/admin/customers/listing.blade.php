				    ...
				    <div class="card">
				      <div class="card-header">
				      	@if(have_right('Access-User'))
					        <h3 class="card-title">
					        	<a href="{{ URL('admin/customers/create') }}" class="btn btn-primary"> Add New </a>
					        </h3>
				        @endif
				      </div>
				      <div class="card-body">
				        <table id="customers-datatable" class="table table-bordered table-striped" style="width:100%">
				          <thead>
				              <tr>
				                <th>ID</th>
				                <th>Name</th>
