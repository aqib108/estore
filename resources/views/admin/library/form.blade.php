...
@section('content')
@php
	$libraryContent = (array)json_decode($libraryType->content);
@endphp
							...
							<div class="accordion" id="accordionExample">
								...
								<div id="message" class="collapse" aria-labelledby="message-heading" data-parent="#accordionExample">
									<div class="card-body">
											...
											<div class="col-sm-4">
												<div class="form-group ">
													<label class="col-form-label">Content {{$language->name}}</label>
														<textarea id="summernote" name="content[{{$language->short_name}}]" required>{{isset($libraryContent[$language->short_name])?$libraryContent[$language->short_name]:''}}</textarea>
												</div>
											</div>
											@endforeach
												{{--  <div class="col-sm-4">
