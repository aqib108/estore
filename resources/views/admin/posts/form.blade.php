                        ...
                        <div class="card-body">
                            <form id="post-form" class="form-horizontal label-left" action="{{ URL('admin/posts') }}" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    @php $fImage = asset('feature-images/'.$row->featureImage->image); @endphp
                                    @else
                                    @php $fImage = '#'; @endphp
                                    @endif
                                    ...
                                    @php $tImage = asset('theme-images/'.$row->themeImage->image); @endphp
                                    @else
                                    @php $tImage = '#'; @endphp
                                    @endif
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Title {{$language->name}}</label>
                                        <div class="col-sm-6">
                                    ...
                                    @foreach($languages as $language)
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Short Description {{$language->name}}</label>
                                        <div class="col-sm-6">
                                            <textarea class="form-control" name="short_description[{{$language->short_name}}]" placeholder="Enter Short Description in {{$language->name}}" required="">{{isset($short_description[$language->short_name])?$short_description[$language->short_name]:''}}</textarea>
                                        </div>
                                    </div>
                                    @endforeach
                                    @foreach($languages as $language)
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea id="summernote" name="description[{{$language->short_name}}]">{{isset($description[$language->short_name])?$description[$language->short_name]:''}}</textarea>
                                        </div>
                                    </div>
                                    @endforeach
